    ...
    list: [
      {
        id: 'h1',
        type: 'Honor',
        name: 'Shri Baljit Shastri Award for Best in Human and Traditional Values.',
      ...
      },
      {
        ...
        description: 'Used for detecting and analyzing irrigation and soil mineral levels in Indian Himalayan region\
      ...
      },
      {
        id: 'h4',
        type: 'Honor',
        name: 'Invited to MyGov event held in presence of the Hon’ble Prime Minister of India',
        // eslint-disable-next-line no-multi-str
        description: 'Invited by Ministry of Electronics and Information Technology for the spirit of volunteerism and\
